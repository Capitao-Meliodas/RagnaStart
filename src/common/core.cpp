...
static void display_title(void) {
	...
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                                 " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BT_WHITE "   Modifications by © Creative Services and Development     " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "       " CL_BT_WHITE "               http://creativesd.com.br                        " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                                 " CL_PASS "" CL_CLL "" CL_NORMAL "\n");

#ifdef CSDVERSION
	ShowInfo("CreativeSD Version: '" CL_WHITE "%s" CL_RESET "'\n", CSDVERSION);
#endif
