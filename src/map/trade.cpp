...
void trade_tradeadditem(struct map_session_data *sd, short index, short amount)
{
	...
	// BG Stuff
	if( item->card[0]==CARD0_CREATE && MakeDWord(item->card[2],item->card[3])==battle_config.stuff_bg_reserverd_id && 
	...
	// GvG Stuff
	if( item->card[0]==CARD0_CREATE && MakeDWord(item->card[2],item->card[3])==battle_config.stuff_gvg_reserverd_id && 
	...
	// BG Stuff
	if( item->card[0]==CARD0_CREATE && MakeDWord(item->card[2],item->card[3])==battle_config.stuff_pvp_reserverd_id && 
