...
#ifdef RANKED_SYSTEM_ENABLE
	if (map[m_id].flag.ranked)
		strcat(atcmd_output, " Ranked |");
#endif
	clif_displaymessage(fd, atcmd_output);
...
ACMD_FUNC(autotrade) {
	...
	presence = pc_readaccountreg(sd, add_str("PresenceFlag"));
	if (presence) {
		clif_displaymessage(fd, msg_txt(sd,PRESENCE_MSG_TXT));
		return -1;
	}
...
ACMD_FUNC(mobinfo)
{
	unsigned char msize[SZ_ALL][9] = { "Pequeno", "Medio", "Grande" };
	unsigned char mrace[RC_ALL][13] = { "Amorfo", "Morto-Vivo", "Bruto", "Planta", "Inseto", "Peixe", "Demonio", "Humanoide", "Anjo", "Dragão", "Player" };
	unsigned char melement[ELE_ALL][11] = { "Neutro", "Água", "Terra", "Fogo", "Vento", "Poison", "Sagrado", "Sombrio", "Fantasma", "Morto-Vivo" };
 ...
 *------------------------------------------*/
#include "queue_atcommandfunc.inc"
#endif
 ...
 *------------------------------------------*/
#include "battleground_atcommandfunc.inc"
#endif
 ...
 * [CreativeSD]: Ranked System
 *------------------------------------------*/
#include "atcommand_ranked_func.inc"
#endif
...
#include "../custom/atcommand_def.inc"
	 ...
	 * CreativeSD: Queue System
	 *------------------------------------------*/
#include "queue_atcommanddef.inc"
#endif
#ifdef BG_WARFARE_ENABLE
	 /*==========================================
	  * CreativeSD: Battleground Warfare
	  *------------------------------------------*/
#include "battleground_atcommanddef.inc"
#endif
#ifdef RANKED_SYSTEM_ENABLE
	/*==========================================
	 * [CreativeSD]: Ranked System
	 *------------------------------------------*/
#include "atcommand_ranked_def.inc"
#endif
		// [CreativeSD]: Organized Shops
