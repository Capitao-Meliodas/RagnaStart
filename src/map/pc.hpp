...
#include "battleground.hpp" // struct battleground_statistic [CreativeSD]
#endif
...
struct map_session_data {
	...
	struct batleground_statistic bg_score;
#endif
	...
	struct {
		...
		int current_rank;
		int display_timer;
		float account_points; // Save in #RANKED_ACCOUNT_POINTS
		int disable;
	} ranked;
#endif
